...
namespace PVModele.Tables
{
    ...
    [Table(Name = "TPatVaguesFormatOuvert")]
    public class PatVaguesFormatOuvert
    {
        ...
        /// </summary>
        [PrimaryKey, Identity]
        [Column(Name = "ClePatVagues")]
        public int ClePatVagues { get; set; }
        ...
        /// </summary>
        [Column(Name = "MeilleurRangPrecedent")]
        public int MeilleurRangPrecedent { get; set; }

        /// <summary>
        /// 1 --> Avancé mais aurait quand même fait la demi ou la finale. 2 --> Avancé et n' aurait pas fait la demi ou la finale A (entier long)
        /// </summary>
        [Column(Name = "MeilleurTempsPrecedent")]
        public int MeilleurTempsPrecedent { get; set; }

        /// <summary>
        /// 1 --> Avancé mais aurait quand même fait la demi ou la finale. 2 --> Avancé et n' aurait pas fait la demi ou la finale A (entier long)
        /// </summary>
        [Column(Name = "RangRonde1")]
        public int RangRonde1 { get; set; }
